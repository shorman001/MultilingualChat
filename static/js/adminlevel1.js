// File: static/js/admin.js
    (function () {
        ...
        var pusher = new Pusher('f7de384babef4471a3bc', {
        ...
        const helpers = {
            ...
            // ------------------------------------------------------------------
            // Add a user chat message to the chat window.
            // ------------------------------------------------------------------
            ...
            displayChatMessage: (message) => {
                {
                    ...
                    $('#chat-msgs').prepend(
                        `<tr>
                            <td>
                                <div class="sender">${message.sender} @ <span class="date">${message.createdAt} ===> ${message.langcust}  </span></div>
            ...
            // ------------------------------------------------------------------
            // Add a admin chat message to the chat window.
            // ------------------------------------------------------------------

            displayChatMessage1: (message) => {
                {

                    $('#chat-msgs').prepend(
                        `<tr>
                            <td>
                                <div class="sender">${message.sender} @ <span class="date">${message.createdAt} ===> ${message.email}  </span></div>
                                <div class="message">${message.text}</div>
                            </td>
                        </tr>`
                    )
